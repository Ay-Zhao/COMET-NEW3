...
# # before reloading — this is the ONLY reliable way to reset S4 state
# if (pkgload::is_dev_package("COMET")) {
#   pkgload::unload("COMET")   # fully tears down namespace + S4 registry
# }
#
# devtools::load_all()
...
source("R/s4_config.R")
source("R/s4_policy.R")
source("R/s4_result.R")
source("R/s4_simulator.R")
source("R/s4_experiment.R")
